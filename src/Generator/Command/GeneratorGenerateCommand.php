...
class GeneratorGenerateCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('lle:easy-admin-plus:generator:generate')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): void
    {
        ...
        $cleanCommand = $this->getApplication()->find('lle:easy-admin-plus:generator:cleanup');
        ...
        try {
            $eaTool = $container->get('lle.easy_admin_plus.generator.generate');
            $eaTool->run();
        } catch (EAException $e) {

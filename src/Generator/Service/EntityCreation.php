...
class EntityCreation
{
    ...
    public function run(ClassMetadata $metaData): ?Entity
    {
        ...
        $entity = (new Entity($metaData))
            ...
            ->setProperties($this->entityPropertiesCreation->run())
            ->setMethods($this->methodCreation->run($entity, $generatorParameters));


//        $this->buildProperties($metaData, $entity);
//        $entity->buildMethods($this->parameterBag->get('easy_admin_plus')['generator']);
